          ...
          <div>
            ...
            >
              <a
                ...
                className="inline-flex min-h-11 items-center justify-center gap-2 rounded-full bg-emerald-500 px-6 py-3.5 text-sm font-bold text-white shadow-[0_4px_24px_rgba(16,185,129,0.45)] ring-2 ring-emerald-300/40 transition-all duration-300 hover:bg-emerald-400 active:opacity-90"
              >
